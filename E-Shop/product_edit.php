...
<head>
	<title> eShop </title>
	<link rel="stylesheet" href="/E-Shop/bootstrap-3.3.5/css/bootstrap.css">
	<link href="/E-Shop/css/main.css" rel="stylesheet" type="text/css" />
...
<body>
				...
				<table width="90%" border="0" cellspacing="0" cellpadding="6">
					...
					<tr>
						...
						<td><label>
							...
							<input type="submit" name="button" id="button" value="Confirm Changes" onclick="javascript:return validateMyForm();" />
						</label></td>
					</tr>
				</table>
			</form>
	...
	<script src="/E-Shop/js/main.js"></script>
	<script src="/E-Shop/bootstrap-3.3.5/js/bootstrap.js"></script>
	<script type="text/javascript" src="/E-Shop/js/jquery.leanModal.min.js"></script>
	<s
</body>